...
public class TeacherDao extends BaseDao {
	public boolean addTeacher(Teacher teacher){
		...
		sql += ",'" + teacher.getTemperature() + "',null)";
		sql += ",'" + teacher.getAddress() + "',null)";
		sql += ",'" + teacher.getHubei() + "',null)";
		sql += ",'" + teacher.getWuhan() + "',null)";
		return update(sql);
	}
	public boolean editTeacher(Teacher teacher) {
		...
		sql += ",temperature = '" + teacher.getTemperature() + "'";
		sql += ",address = '" + teacher.getAddress() + "'";
		sql += ",hubei = '" + teacher.getHubei() + "'";
		sql += ",wuhan = '" + teacher.getWuhan() + "'";
	...
	public Teacher getTeacher(int id){
		...
		try {
			if(resultSet.next()){
				...
				teacher.setTemperature(resultSet.getString("temperature"));
				teacher.setAddress(resultSet.getString("address"));
				teacher.setHubei(resultSet.getString("hubei"));
				teacher.setWuhan(resultSet.getString("wuhan"));
	...
	public List<Teacher> getTeacherList(Teacher teacher,Page page){
		...
		try {
			while(resultSet.next()){
				...
				t.setTemperature(resultSet.getString("temperature"));
				t.setAddress(resultSet.getString("address"));
				t.setHubei(resultSet.getString("hubei"));
				t.setWuhan(resultSet.getString("wuhan"));
	...
	public Teacher login(String name ,String password){
		...
		try {
			if(resultSet.next()){
				...
				teacher.setMobile(resultSet.getString("mobile"));
				teacher.setPhoto(resultSet.getBinaryStream("photo"));
				teacher.setTemperature(resultSet.getString("tenperature"));
				teacher.setAddress(resultSet.getString("address"));
				teacher.setHubei(resultSet.getString("hubei"));
				teacher.setWuhan(resultSet.getString("wuhan"));
				teacher.setSex(resultSet.getString("sex"));
