...
public class StudentDao extends BaseDao {
	public boolean addStudent(Student student){
		...
		sql += ",'" + student.getTemperature() + "',null)";
		sql += ",'" + student.getAddress() + "',null)";
		sql += ",'" + student.Hubei() + "',null)";
		sql += ",'" + student.wuhan() + "',null)";
		return update(sql);
	}
	public boolean editStudent(Student student) {
		...
		sql += ",temperature = '" + student.getTemperature() + "'";
		sql += ",address = '" + student.getAddress() + "'";
		sql += ",hubei = '" + student.Hubei() + "'";
		sql += ",wuhan = '" + student.wuhan() + "'";
	...
	public Student getStudent(int id){
		...
		try {
			if(resultSet.next()){
				...
				student.setTemperature(resultSet.getString("temperature"));
				student.setAddress(resultSet.getString("address"));
				student.setHubei(resultSet.getString("hubei"));
				student.setWuhan(resultSet.getString("wuhan"));
	...
	public List<Student> getStudentList(Student student,Page page){
		...
		try {
			while(resultSet.next()){
				...
				s.setTemperature(resultSet.getString("temperature"));
				s.setAddress(resultSet.getString("address"));
				s.setHubei(resultSet.getString("hubei"));
				s.setWuhan(resultSet.getString("wuhan"));
